...
struct CompiledKernel {
    ...
    constants: FxHashMap<char, HipSlice<u8>>,
    /// Graph node handle (set after graph is built)
    graph_node: Option<hipGraphNode_t>,
...
impl RocmGraphOp {
    ...
    fn build_graph(
        ...
        let mut prev_graph_node: Option<hipGraphNode_t> = None;
        ...
        for idx in 0..num_kernels {
            ...
            let deps: &[hipGraphNode_t] = match (&prev_graph_node, timing_event) {
