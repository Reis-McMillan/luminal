...
//! `cargo test -p luminal_rocm_lite -- --ignored` when touching extraction,
...
mod llama {
    ...
    #[test]
    #[ignore = "expensive ROCm model genome fuzzing; run with cargo test -p luminal_rocm_lite -- --ignored"]
    fn fuzz_llama_mlp() {
