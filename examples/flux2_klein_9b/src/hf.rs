...
//! single FP32 file: Flux 2's transformer weights are large on disk in BF16
//! and the Qwen3 text encoder is several GB. We download the original BF16 / F32
...
const REPO_ID: &str = "black-forest-labs/FLUX.2-klein-9B";
...
/// Tokenizer JSON (Qwen2 tokenizer used by Klein's Qwen3 text encoder).
